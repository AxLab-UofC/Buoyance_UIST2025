...
void oscEvent(OscMessage msg) {
  ...
  //optitrack motion tracking data
  else if (trackingMode && msg.checkAddrPattern("/robot")){
    ...
    robots[id].setPosition(new PVector(pos_x*1000, -pos_z*1000));
    robots[id].setAngle(radians(angle_y));
