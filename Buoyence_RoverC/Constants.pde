...
//String[] ips_xy = {"192.168.0.162", "192.168.0.2", "192.168.0.102", "192.168.0.114"};
//String[] ips_xy = {"192.168.0.102", "192.168.0.130"};
//String[] ips_xy = {"192.168.0.102"};
String[] ips_xy = {};
...
//String[] ips_z = {"192.168.0.66", "192.168.0.182", "192.168.0.78", "192.168.0.154"};
//String[] ips_z = {"192.168.0.182", "192.168.0.154"};
//String[] ips_z = {"192.168.0.78"};
String[] ips_z = {};
...
// Number of obstacles
int nObstacles = 0;
// Number of markers on hands, i.e. 2 markers per hand //<>// //<>// //<>//
int nHands = 2;
 //<>// //<>//
/* -------------------------------------------------------------------------- */
...
// Error detection for camera tracking
boolean tracking_robot = true;
boolean[] tracking_gesture = new boolean[nHands];

// enable these to render rigBots
boolean enable3Dview = true;
boolean debugView = true;
boolean wifiConnectionMode = false;
